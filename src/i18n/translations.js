const translations = {
  en: {
    nav: {
      ...
      iplNews: 'IPL News',
      events: 'Events',
      friendshipMeets: 'Friendship Meets',
    ...
    home: {
      ...
      founder_quote: 'Let us breathe friendship !\nLet us love our friends !\nLet us sow love, friendship, and humanity !\nLet us nurture and continue tirelessly, the journey of friendship...',
      founder_name: 'M. Karun, Founder - President',
      ...
      registration_value: '#F23778',
      tax_benefit_label: 'Tax Benefit',
      tax_benefit_value: '80G Certified',
    ...
    ourteam: {
      ...
      board_of_trustee: 'Board of Trustee',
      board_of_trustees: 'Board of Trustees',
      team_coming_soon: 'Team Coming Soon',
      team_coming_soon_desc: "We're assembling our team of dedicated volunteers.",
    },
    meet: {
      ...
      annual_heading: "IPL's FRIENDS DAY",
    ...
    history: {
      ...
      timeline: {
        ...
        subtitle: 'Key moments that shaped our journey of love, friendship, and humanitarian service.',
      },
      milestones: {
    ...
    feedback: {
      ...
      category_issue: 'Website Issue',
      category_correction: 'Content Correction',
      category_other: 'Other',
      message: 'Message',
      message_placeholder: 'Please share your feedback, suggestion, or issue...',
      ...
      error_message_short: 'Message is too short (minimum 10 characters)',
      error_message_long: 'Message is too long (max 2000 characters)',
      error_submit: 'Something went wrong. Please try again later.',
    },
    humanitarian: {
      subtitle: 'Serving Humanity with Love and Compassion',
      our_activities: 'Our Humanitarian Activities',
      explore_initiatives: 'Explore our initiatives making a positive impact in communities worldwide',
    ...
    about: {
      ...
      badge: 'Who We Are',
      no_content: 'No about content available.',
      mission: 'Our Mission',
    ...
    meet: {
      ...
      loading: 'Loading friendship meets...',
      view_details_arrow: 'View Details →',
      no_events: 'No events available',
      filter_help: 'Try adjusting your filters or check back later',
      gallery: 'Gallery',
    ...
    friendshipMeets: {
      ...
      subtitle: 'Celebrating friendship across borders since decades. Join us in the spirit of international friendship and unity.',
      filter_title: 'Filter Meets',
      ...
      view_details: 'View Details →',
      no_events: 'No events available',
      no_events_sub: 'Try adjusting your filters or check back later',
      clear_all_filters: 'Clear all filters',
    },
    organiser: {
      badge: "Organiser's",
      subtitle: 'Our global organisers — filter by country, state and district',
    },
    joinnow: {
      content_coming_soon: 'Content coming soon...',
      google_form_unavailable: 'Google form not available',
    },
    service: {
      not_found: 'Service Not Found',
      not_found_desc: "The humanitarian service you're looking for doesn't exist.",
      humanitarian_service: 'Humanitarian Service',
      date: 'Date',
      location: 'Location',
      about_service: 'About This Service',
    },
    friendsday: {
      badge: 'International Friendship Day',
      highlight1: {
        title: 'Celebrate Friendship',
        desc: 'Honor the beautiful bonds formed through pen pal connections',
      },
      highlight2: {
        title: 'Exchange Gifts',
        desc: 'Share tokens of appreciation and friendship bands',
      },
      highlight3: {
        title: 'Global Unity',
        desc: 'Connect with friends across borders and cultures',
      },
      highlight4: {
        title: 'Create Memories',
        desc: 'Capture beautiful moments with your pen pals',
      },
      stats: {
        years: 'Years',
        members: 'Members',
  ...
  ta: {
    nav: {
      ...
      events: 'நிகழ்வுகள்',
      friendshipMeets: 'நட்புச் சங்கமம்',
      friendsDay: 'நட்பினர் தினம்',
    ...
    home: {
      ...
      founder_quote: 'நட்பை சுவாசிப்போம்!\nநண்பர்களை நேசிப்போம்!\nஅன்பு, நட்பு, மனிதநேயம் விதைப்போம்! வளர்ப்போம்!\nதொய்வின்றி தொடர்வோம்! நட்புப் பயணத்தை...',
  ...
  ourteam: {
    ...
    founder_president: 'நிறுவனர், தலைவர்',
    board_of_trustee: 'அறங்காவலர் குழு',
    board_of_trustees: 'அறங்காவலர் குழு',
    team_coming_soon: 'குழு விரைவில்',
    team_coming_soon_desc: 'நாங்கள் எங்கள் அர்ப்பணிப்புள்ள தன்னார்வலர்களின் குழுவை உருவாக்கி வருகிறோம்.',
  },
  meet: {
  ...
  friendshipMeets: {
    ...
    subtitle: 'பல தசாப்தங்களாக எல்லைகளைக் கடந்து நட்பை கொண்டாடுகிறோம். சர்வதேச நட்பு மற்றும் ஒற்றுமையின் உணர்வில் எங்களுடன் சேருங்கள்.',
    filter_title: 'சங்கமங்களை வடிகட்டு',
    clear_filters: 'வடிகட்டலை நீக்கு',
    year: 'ஆண்டு',
    all_years: 'அனைத்து ஆண்டுகளும்',
    loading: 'நட்புச் சங்கமங்கள் ஏற்றப்படுகின்றன...',
    view_details: 'விவரங்களைக் காண்க →',
    no_events: 'நிகழ்வுகள் எதுவும் இல்லை',
    no_events_sub: 'வடிகட்டலை மாற்றிப் பாருங்கள் அல்லது பின்னர் மீண்டும் பார்க்கவும்',
    clear_all_filters: 'அனைத்து வடிகட்டல்களையும் நீக்கு',
  },
  contact: {
  ...
  feedback: {
    ...
    category: 'வகை',
    category_suggestion: 'பரிந்துரை',
    category_issue: 'இணையப்பதிவு சிக்கல்',
    category_correction: 'உள்ளடக்க திருத்தம்',
    category_other: 'மற்றவை',
    message: 'செய்தி',
    message_placeholder: 'உங்கள் கருத்து, பரிந்துரை அல்லது சிக்கலை பகிரவும்...',
    submit: 'கருத்து அனுப்புங்கள்',
    sending: 'அனுப்புகிறது...',
    sent: 'அனுப்பப்பட்டுவிட்டது!',
    success_message: 'நன்றி! உங்கள் கருத்து அனுப்பப்பட்டুள்ளது.',
    error_name_required: 'தயவுசெய்து உங்கள் பெயரை உள்ளிடவும்',
    error_name_long: 'பெயர் மிக நீளமாக உள்ளது',
    error_email_invalid: 'தயவுசெய்து சரியான மின்னஞ்சலை உள்ளிடவும்',
    error_message_required: 'தயவுசெய்து செய்தியை உள்ளிடவும்',
    error_message_short: 'செய்தி மிக குறுகியது (குறைந்தபட்சம் 10 எழுத்துக்கள்)',
    error_message_long: 'செய்தி மிக நீளமாக உள்ளது (வரம்பு 2000 எழுத்துக்கள்)',
    error_submit: 'ஏதோ தவறு ஏற்பட்டது. பின்னர் மீண்டும் முயற்சிக்கவும்.',
  },
  humanitarian: {
  ...
  meet: {
    ...
    loading: 'நட்புச் சங்கமங்கள் ஏற்றப்படுகிறது...',
    view_details_arrow: 'விவரங்களைப் பார்க்க →',
    no_events: 'நிகழ்வுகள் எதுவும் இல்லை',
    filter_help: 'உங்கள் வடிப்பான்களை சரிசெய்யவும் அல்லது பின்னர் பார்க்கவும்',
    gallery: 'படத்தொகுப்பு',
    meet_not_found: 'சங்கமம் கிடைக்கவில்லை',
    loading_text: 'ஏற்றப்படுகிறது...',
  },
  organiser: {
    badge: 'ஒருங்கிணைப்பாளர்',
    subtitle: 'எங்கள் உலகளாவிய ஒருங்கிணைப்பாளர்கள் — நாடு, மாநிலம் மற்றும் மாவட்டத்தின் படி வடிகட்டவும்',
  },
  joinnow: {
    content_coming_soon: 'உள்ளடக்கம் விரைவில் வரும்...',
    google_form_unavailable: 'Google படிவம் கிடைக்கவில்லை',
  },
  service: {
    not_found: 'சேவை கிடைக்கவில்லை',
    not_found_desc: 'நீங்கள் தேடும் மனிதநேய சேவை இல்லை.',
    humanitarian_service: 'மனிதநேய சேவை',
    date: 'தேதி',
    location: 'இடம்',
    about_service: 'இந்த சேவை பற்றி',
  },
  friendsday: {
    badge: 'சர்வதேச நண்பர்கள் தினம்',
    highlight1: {
      title: 'நட்பை கொண்டாடுங்கள்',
      desc: 'பேனா நண்பர் தொடர்புகள் மூலம் உருவான அழகான பந்தங்களைக் கௌரவிக்கவும்',
    },
    highlight2: {
      title: 'பரிசுகளை பரிமாறவும்',
      desc: 'பாராட்டு மற்றும் நட்பு பட்டைகளை பகிர்ந்து கொள்ளவும்',
    },
    highlight3: {
      title: 'உலகளாவிய ஒற்றுமை',
      desc: 'எல்லைகள் மற்றும் பண்பாடுகளுக்கு அப்பால் நண்பர்களுடன் இணையுங்கள்',
    },
    highlight4: {
      title: 'நினைவுகளை உருவாக்குங்கள்',
      desc: 'உங்கள் பேனா நண்பர்களுடன் அழகான தருணங்களை படமெடுக்கவும்',
    },
    stats: {
      years: 'ஆண்டுகள்',
  ...
  history: {
    ...
    timeline: {
      ...
      subtitle: 'அன்பு, நட்பு மற்றும் மனிதநேய சேவையின் பயணத்தை வடிவமைத்த முக்கிய தருணங்கள்.',
    },
    milestones: {
